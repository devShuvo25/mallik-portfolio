  ...
  { 
    ...
    icon: (
      <svg viewBox="0 0 24 24" className="w-10 h-10">
        ...
        <path
          d="M13.5 12h2.25c1.243 0 2.25.84 2.25 2.25 0 1.41-1.007 2.25-2.25 2.25h-2.25v-1.5h2.25c.414 0 .75-.336.75-.75 0-.414-.336-.75-.75-.75H13.5V12zm-7.5 0h6v1.5H9.75V18h-1.5v-4.5H6V12z"
          fill="#fff"
        />
      </svg>
    ) 
